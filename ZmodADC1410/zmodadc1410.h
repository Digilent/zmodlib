...
#define ZMODADC1410_CALIB_USER_ADDR 0x7000
#define ZMODADC1410_CALIB_FACT_ADDR 0x8100

#define ZMODADC1410_CALIB_ID	0xAD

typedef struct _CALIBECLYPSEADC{    // 128 B
