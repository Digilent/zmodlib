...
// ZMODDAC1411 specific registers
...
#define ZMODDAC1411_CALIB_USER_ADDR 0x7000
#define ZMODDAC1411_CALIB_FACT_ADDR 0x8100

#define ZMODDAC1411_CALIB_ID	0xDA

typedef struct _CALIBECLYPSEDAC{    // 128 B
